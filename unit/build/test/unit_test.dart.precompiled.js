...
["tile_mapper_test", "unit_test.dart", , S, {
  "^": "",
  main: [function() {
    var body, e, e0, t1;
    body = document.querySelector("body");
    e = document.createElement("img", null);
    J.set$src$x(e, "images/idle.png");
    e0 = document.createElement("canvas", null);
    J.set$width$x(e0, 400);
    J.set$height$x(e0, 300);
    t1 = J.get$onLoad$x(e);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new S.main_closure(body, e, e0)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    J.get$children$x(body).add$1(0, e);
  }, "call$0", "main$closure", 0, 0, 6],
  main_closure: {
    "^": "Closure:18;body_1,innerImg_2,innerCanvas_3",
    call$1: function(e) {
      var t1, header, t2, t3, t4, sprites, idleFrames, t5;
      t1 = {};
      header = document.createElement("h1", null);
      header.textContent = "Nothing";
      t2 = this.body_1;
      t3 = J.getInterceptor$x(t2);
      t3.get$children(t2).add$1(0, header);
      t4 = this.innerCanvas_3;
      t3.get$children(t2).add$1(0, t4);
      sprites = P.LinkedHashMap_LinkedHashMap(null, null, null, null, S.Sprite);
      idleFrames = P.List_List$generate(3, new S.main__closure(), true, S.Frame);
      t2 = this.innerImg_2;
      t3 = $.get$AnimationData_OVERWORLD_IDLE();
      t5 = new S.Sprite(null, idleFrames, t2, null, null, t3);
      t5.Sprite$3(t2, idleFrames, t3);
      sprites.$indexSet(0, "overworld", t5);
      t1.frame_0 = 0;
      J.get$context2D$x(t4).fillStyle = "white";
      P.Timer_Timer$periodic(P.Duration$(0, 0, 0, 16, 0, 0), new S.main__anim(t1, t4, new S.Unit(null, sprites, null)));
    }
  },
  main__closure: {
    "^": "Closure:8;",
    call$1: function(i) {
      return new S.Frame(i * 64, 0, 64, 128);
    }
  },
  main__anim: {
    "^": "Closure:19;box_0,innerCanvas_4,lyn_5",
    call$1: function(t) {
      var t1, t2, t3;
      t1 = this.innerCanvas_4;
      t1.getContext("2d").fillRect(0, 0, t1.width, t1.height);
      t2 = this.lyn_5.sprites;
      t3 = this.box_0;
      t2.$index(0, "overworld").setAnimationFrame$1(t3.frame_0);
      t2.$index(0, "overworld").drawSelf$5(t1.getContext("2d"), 0, 0, 32, 64);
      ++t3.frame_0;
    }
  }
},
1],
["unit", "package:unit/unit.dart", , S, {
  "^": "",
  Frame: {
  ...
  Sprite: {
    "^": "Object;frame,imgFrames,img,animationFrame,animationLength,animationData",
    drawSelf$5: function(context, x, y, renderWidth, renderHeight) {
      var t1, t2, f;
      t1 = this.imgFrames;
      t2 = this.frame;
      ...
      context.drawImage(this.img, t2.get$x(f), t2.get$y(f), t2.get$width(f), t2.get$height(f), x, y, renderWidth, renderHeight);
    },
    setAnimationFrame$1: function(a) {
      var t1, i, t2, t3, it;
      t1 = this.animationLength;
      if (typeof t1 !== "number")
        return H.iae(t1);
      this.animationFrame = C.JSInt_methods.$mod(a, t1);
      for (t1 = this.animationData, i = 0; i < 4; ++i) {
        t2 = this.animationFrame;
        t3 = t1[i].get$keys();
        it = t3.get$iterator(t3);
        if (!it.moveNext$0())
        ...
        if (t2 < t3) {
          ...
          if (!it.moveNext$0())
            H.throwExpression(H.IterableElementError_noElement());
          this.frame = t2._f$1(it.get$current());
          return;
        }
      }
    },
    Sprite$3: function(img, imgFrames, animationData) {
      var t1;
      this.frame = 0;
      t1 = this.animationData[3].get$keys();
      this.animationLength = t1.get$first(t1);
    }
  },
  Unit: {
    "^": "Object;stats,sprites,currentSprite"
  }
}],
]);
...
Isolate.$lazy($, "OVERWORLD_IDLE", "AnimationData_OVERWORLD_IDLE", "get$AnimationData_OVERWORLD_IDLE", function() {
  return [P.LinkedHashMap_LinkedHashMap$_literal([40, 0], null, null), P.LinkedHashMap_LinkedHashMap$_literal([42, 1], null, null), P.LinkedHashMap_LinkedHashMap$_literal([82, 2], null, null), P.LinkedHashMap_LinkedHashMap$_literal([84, 1], null, null)];
});
// Native classes
...
function dart_precompiled($collectedClasses) {
  ...
  function main_closure(body_1, innerImg_2, innerCanvas_3) {
    this.body_1 = body_1;
    this.innerImg_2 = innerImg_2;
    this.innerCanvas_3 = innerCanvas_3;
  }
  ...
  function main__anim(box_0, innerCanvas_4, lyn_5) {
    this.box_0 = box_0;
    this.innerCanvas_4 = innerCanvas_4;
    this.lyn_5 = lyn_5;
  }
  main__anim.builtin$cls = "main__anim";
  if (!"name" in main__anim)
    main__anim.name = "main__anim";
  $desc = $collectedClasses.main__anim;
  if ($desc instanceof Array)
    $desc = $desc[1];
  main__anim.prototype = $desc;
  ...
  Frame.prototype.get$x = function(receiver) {
    return this.x;
  };
  Frame.prototype.get$y = function(receiver) {
    return this.y;
  };
  Frame.prototype.get$width = function(receiver) {
    return this.width;
  };
  Frame.prototype.get$height = function(receiver) {
    return this.height;
  };
  function Sprite(frame, imgFrames, img, animationFrame, animationLength, animationData) {
    this.frame = frame;
  ...
  function Unit(stats, sprites, currentSprite) {
    this.stats = stats;
